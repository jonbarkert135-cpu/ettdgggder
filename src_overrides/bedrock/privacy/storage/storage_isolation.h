...
#ifndef BEDROCK_PRIVACY_STORAGE_STORAGE_ISOLATION_H_
#define BEDROCK_PRIVACY_STORAGE_STORAGE_ISOLATION_H_
...
#endif  // BEDROCK_PRIVACY_STORAGE_STORAGE_ISOLATION_H_
