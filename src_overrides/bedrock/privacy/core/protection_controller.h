...
#ifndef BEDROCK_PRIVACY_CORE_PROTECTION_CONTROLLER_H_
#define BEDROCK_PRIVACY_CORE_PROTECTION_CONTROLLER_H_
...
#endif  // BEDROCK_PRIVACY_CORE_PROTECTION_CONTROLLER_H_
