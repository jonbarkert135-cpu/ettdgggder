...
#ifndef BEDROCK_PRIVACY_PRIVACY_POLICY_H_
#define BEDROCK_PRIVACY_PRIVACY_POLICY_H_

#include <string>
#include <vector>

#include "bedrock/net/dns_settings.h"
...
#endif  // BEDROCK_PRIVACY_PRIVACY_POLICY_H_
