...
#ifndef BEDROCK_PRIVACY_SECURITY_SECURITY_BASELINE_H_
#define BEDROCK_PRIVACY_SECURITY_SECURITY_BASELINE_H_
...
#endif  // BEDROCK_PRIVACY_SECURITY_SECURITY_BASELINE_H_
